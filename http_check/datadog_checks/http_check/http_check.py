                ...
                if re.search(content_match, content, re.UNICODE):
                    if reverse_content_match:
                        send_status_down('{} is found in return content with the reverse_content_match option'
                                         .format(repr(content_match)),
                                         'Content "{}" found in response with the reverse_content_match'
                                         .format(repr(content_match)))
                    else:
                        send_status_up("{} is found in return content".format(repr(content_match)))
                    ...
                    if reverse_content_match:
                        ...
                        send_status_down("{} is not found in return content".format(repr(content_match)),
                                         'Content "{}" not found in response.'.format(repr(content_match)))
